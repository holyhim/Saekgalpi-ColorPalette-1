...
const Main = ({ isLogin, favPalettes, currentPalettes, dispatch }) => {
    ...
    return (
        <main className='main__main-content'>
            ...
            <section className='fav-palettes__container'>
                ...
                <PaletteList dispatch={dispatch} palettes={favPalettes} />
            </section>
            <section className='current-palettes__container'>
                <h3 className='current-palettes__title'>새로운 색갈피</h3>
                <PaletteList dispatch={dispatch} palettes={currentPalettes} />
            </section>
